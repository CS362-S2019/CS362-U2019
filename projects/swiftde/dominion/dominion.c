...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  case minion:
    return minionCard(handPos, currentPlayer, choice1, choice2, state);
...
int ambassadorCard(int choice2, int choice1, int currentPlayer, int handPos, struct gameState *state)
{
...
int tributeCard(struct gameState *state, int nextPlayer, int currentPlayer)
{
  ...
  else
  {
    ...
    tributeRevealedCards[0] = state->deck[nextPlayer][state->deckCount[nextPlayer] - 2];
