...
/* ASSIGNMENT 2 CHANGES
    Removed implementations for the following switch statements and put them in seperate functions
        Baron, Ambassador, Tribute, Minion, Mine
    Added function calls to the switch statement
*/
