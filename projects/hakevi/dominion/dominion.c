...
/*** Minion ***/
int minionR (struct gameState *state, int choice1, int choice2, int handPos)
{
      int currentPlayer = whoseTurn(state);
      int i;
      int j;
...
/*** Ambassador ***/
int ambassadorR(struct gameState *state, int choice1, int choice2, int handPos)
{
  int currentPlayer = whoseTurn(state);
  int i;
  int j;
...
/*** Tribute ***/
int tributeR (struct gameState *state, int choice1, int choice2, int handPos)
  ...
  switch( card ) 
    {
    	...
    	case mine: mineR (state, choice1, choice2, handPos);
    	case tribute: tributeR (state, choice1, choice2, handPos);
    	case ambassador: ambassadorR(state, choice2, choice1, handPos);
    	case minion: minionR (state, choice1, choice2, handPos);
    	case baron: baronR(state, choice1);
