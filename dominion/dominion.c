...
{
  int i = 0;//assigned variables to 0 and deleted redefinitons in each case to save lines
  int j = 0;
  int k = 0;
  int x = 0;
  int index = 0;
  ...
  switch( card ) 
    ...
    case mine:
		mineCase(choice1, choice1, currentPlayer, handPos, state);
...
/*************************************************************
*				 Baron CardEffect Function
*************************************************************/
int baronCase(int choice1, struct gameState *state, int currentPlayer) {
